...
) ENGINE = InnoDB AUTO_INCREMENT = 99 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '菜单' ROW_FORMAT = DYNAMIC;
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, '2020-02-09 23:11:17', 0, '2024-05-07 21:18:46', 1, 'admin', '超级管理员', '$2a$10$Ja/x.8cWHKQ/6kaZLZWu6uj2lD9PBVcPUsIjHpdCluvts0tjwa5je', '13800138000', 'admin@vector.com', 'UNKNOWN', 'ENABLED', 'https://wengxs.oss-cn-shenzhen.aliyuncs.com/20240507/474faa2d-99e4-4600-9cf9-b52726348be2.jpg', 2, '1111');
